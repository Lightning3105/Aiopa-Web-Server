...
_pygame_event.pump() to keep everything current. You'll want to call this
...
_pygame_event.set_allowed() and _pygame_event.set_blocked() to work with
...
own new events with the _pygame_event.Event() function.
...
from SDL import *
import _pygame_base
import _pygame_locals
import _pygame_display
