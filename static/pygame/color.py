...
def Color(colorname):
    """_pygame_color.Color(colorname) -> RGBA
...
def add(color1, color2):
    """_pygame_color.add(color1, color2) -> RGBA
       add two colors
...
def subtract(color1, color2):
    """_pygame_color.subtract(color1, color2) -> RGBA
       subtract two colors
...
def multiply(color1, color2):
    """_pygame_color.multiply(color1, color2) -> RGBA
       multiply two colors
