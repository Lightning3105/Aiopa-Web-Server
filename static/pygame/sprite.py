...
The use of these classes is entirely optional when using _pygame_ The classes
...
more advanced Groups: _pygame_sprite.RenderUpdates() and
_pygame_sprite.OrderedUpdates().
...
from _pygame_time import get_ticks
...
# Don't depend on _pygame_mask if it's not there...
try:
    from _pygame_mask import from_surface
except:
    pass
...
class Sprite(object):
    ...
    _pygame_sprite.Sprite(*groups): return Sprite
...
class DirtySprite(Sprite):
    ...
    _pygame_sprite.DirtySprite(*groups): return DirtySprite
...
class AbstractGroup(object):
    ...
    def sprites(self):
        ...
        _pygame_) Alternatively, you can get the same information by iterating
...
class Group(AbstractGroup):
    ...
    _pygame_sprite.Group(*sprites): return Group
...
class RenderUpdates(Group):
    ...
    _pygame_sprite.RenderUpdates(*sprites): return RenderUpdates

    This class is derived from _pygame_sprite.Group(). It has an enhanced draw
...
class OrderedUpdates(RenderUpdates):
    ...
    _pygame_sprite.OrderedUpdates(*spites): return OrderedUpdates

    This class derives from _pygame_sprite.RenderUpdates().  It maintains
...
class LayeredUpdates(AbstractGroup):
    ...
    _pygame_sprite.LayeredUpdates(*spites, **kwargs): return LayeredUpdates

    This group is fully compatible with _pygame_sprite.Sprite.
    New in pygame 1.8.0
...
class LayeredDirty(LayeredUpdates):
    ...
    _pygame_sprite.LayeredDirty(*spites, **kwargs): return LayeredDirty

    This group requires _pygame_sprite.DirtySprite or any sprite that
    has the following attributes:
        image, rect, dirty, visible, blendmode (see doc of DirtySprite).

    It uses the dirty flag technique and is therefore faster than
    _pygame_sprite.RenderUpdates if you have many static sprites.  It
    ...
    As with the _pygame_sprite.Group, you can specify some additional attributes
    through kwargs:
...
##        print "               check: using dirty rects:", self._use_update
    ...
    def set_clip(self, screen_rect=None):
        ...
        if screen_rect is None:
            self._clip = _pygame_display.get_surface().get_rect()
        else:
...
def collide_rect(left, right):
    ...
    _pygame_sprite.collide_rect(left, right): return bool

    Tests for collision between two sprites. Uses the _pygame_Rect colliderect
...
class collide_rect_ratio:
    ...
    def __call__(self, left, right):
        ...
        _pygame_sprite.collide_rect_ratio(ratio)(left, right): return bool

        Tests for collision between two sprites. Uses the _pygame_Rect
...
def collide_circle(left, right):
    ...
    _pygame_sprite.collide_circle(left, right): return bool
...
class collide_circle_ratio(object):
    ...
    def __call__(self, left, right):
        ...
        _pygame_sprite.collide_circle_radio(ratio)(left, right): return bool
...
def collide_mask(left, right):
    ...
    _pygame_sprite.collide_mask(SpriteLeft, SpriteRight): bool
...
def spritecollide(sprite, group, dokill, collided=None):
    ...
    _pygame_sprite.spritecollide(sprite, group, dokill, collided=None):
        return Sprite_list
...
def groupcollide(groupa, groupb, dokilla, dokillb, collided=None):
    ...
    _pygame_sprite.groupcollide(groupa, groupb, dokilla, dokillb):
        return dict
...
def spritecollideany(sprite, group, collided=None):
    ...
    _pygame_sprite.spritecollideany(sprite, group): return sprite
